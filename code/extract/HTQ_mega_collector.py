...
'''
produces a dict with each text values for each feature + a class value (type) for three languages
the language index is taken from the folder name and needs to be set up accordingly
the dict is written to a tsv
for more information such as number of disintergrated graphs (from test_sanity)
or frequencies of extracted items refer to the help script (overall_freqs)
requies the path of specific length (8) and type (folder names are used to produce metadata!):

'''
# # arg = '/home/masha/02targets_wlv/data/rltc/stu/en/' # 2.2 model
# arg = '/home/masha/02targets_wlv/data/croco/pro/de/' # 2.0
# # arg = '/home/masha/02targets_wlv/data/rltc/stu/ru/' # 2.3

# import os, sys
# import csv
# from extract.get_features.helpfunctions import *
from extract.extractors import *

rootdir = "/home/masha/02targets_wlv/HTQ/htq40sets/"
# rootdir = "/home/masha/HTQE/binary/"
...
for subdir, dirs, files in os.walk(rootdir):
	for i, file in enumerate(files):
		...
		# data hierachy: /home/masha/02targets_wlv/data/croco/pro/de/*.conllu
	...
	with open('/home/masha/02targets_wlv/' + 'htq_40sets_45new_features_Jul21' + '.tsv', "w") as outfile:
